...
-   [aircraft-taxonomy-db.csv](data/aircraft-taxonomy-db.csv) - A list of interesting aircraft with tags, categories and links. (15182)
-   [aircraft-taxonomy-pia.csv](data/aircraft-taxonomy-pia.csv) - A list that contains Privacy ICAO Address (PIA) planes. (0)
...
-   [aircraft-taxonomy-civ.csv](data/aircraft-taxonomy-civ.csv) - Civilian Registered Aircraft, includes Historic and Distinctive. (3968)
-   [aircraft-taxonomy-mil.csv](data/aircraft-taxonomy-mil.csv) - Military Only. (8654)
-   [aircraft-taxonomy-pol.csv](data/aircraft-taxonomy-pol.csv) - Police Forces. (919)
-   [aircraft-taxonomy-gov.csv](data/aircraft-taxonomy-gov.csv) - Governments, Gov Agencies and Dictators. (1641)
...
A list of contributors to the original upstream database can be found at <https://github.com/sdr-enthusiasts/plane-alert-db/graphs/contributors>
